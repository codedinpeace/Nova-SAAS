    ...
    return (
        <div id='Features'>
            <div className='cards  mt-30 max-lg:gap-10 lg:flex  flex-wrap justify-center relative '>
                <div className="card1 mb-10 max-lg:mx-auto h-[950px] w-[543px] max-md:w-80 max-lg:h-[700px] max-lg:w-[400px]">
                    ...
                    <p className='text-[16px] text-white tracking-normal lg:w-100 pl-10 pt-10 max-md:w-70'>With Xora, tedious tasks are history. Automation and smart processes bring your productivity to new heights. It's like having an extra cup of coffee, but without the jitters.</p>
                    <span className=''>
                    <button className=' ml-10 text CTA flex mt-15 text-xl  w-75 max-md:w-60  border-0 rounded-3xl h-15 max-sm:text-[16px] max-sm:rounded-2xl cursor-pointer'><img src={magic} alt=""/><p className='mt-4  pl-2 font-medium'>WATCH THE DEMO</p></button>
                    </span>
                </div>
                <div className="card2 card1 h-[950px] max-lg:mx-auto max-md:w-80 w-[543px] max-lg:h-[700px] max-lg:w-[400px]">
                    ...
                    <p className='text-[16px] text-white tracking-normal lg:w-100 max-md:w-70 pl-10 pt-10'>Your data security is our priority. With state-of-the-art encryption and robust privacy controls, Xora helps keeps your information secure and locked up tighter than Fort Knox.</p>
                    <span className=''>
                    <button className='ml-10 text CTA flex mt-15 text-xl  w-60 border-0 rounded-3xl h-15  max-sm:text-[16px] max-sm:rounded-2xl cursor-pointer'><img src={Docs} alt=""/><p className='mt-4  pl-2 font-medium'>READ THE DOCS</p></button>
                    </span>
                </div>
