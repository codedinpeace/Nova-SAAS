    ...
    return (
        <div className=' mt-50  pricing ' id='Pricing'>
            ...
            <div className='flex justify-center mt-30 relative border-0 flex-wrap max-xl:flex-col max-xl:gap-10 max-xl:mx-auto rounded-4xl'>
                <div className='price-1 w-[443px] h-[682px] max-xl:w-[400px] max-xl:h-[700px] max-xl:mx-auto mt-15 bg-red-500 border-0 rounded-4xl '>
                    ...
                    <button className=' ml-8 text CTA flex mt-10 text-[16px] max-xl:ml-20  w-55 border-1 border-white     rounded-3xl h-15 max-sm:text-[16px] max-sm:rounded-2xl cursor-pointer'><img src={zap} alt=""/><p className='mt-4  pl-2 font-medium'>GET STARTED</p></button>
                    
                </div>
               
                <div className='max-lg:mt-15 price-2 max-xl:mx-auto max-xl:h-[750px] max-xl:w-[400px] w-[443px] h-[782px]  z-10 bg-red-200 xl:absolute border-0 rounded-4xl'>
                    
                    <div className='w-[443px] h-[334px] max-xl:w-[400px] bg-blue-500 border-0 rounded-4xl'>
                ...
                <div className=' price-3 max-xl:mx-auto max-xl:w-[400px] max-lg:h-[700px] w-[643px] h-[682px] mt-15 bg-red-900 border-0 rounded-4xl '>
                ...
                <span className='flex'>
                    ...
                    <button className=' ml-90 text CTA flex mt-10 text-[16px] max-xl:mx-auto w-55 border-1 border-white     rounded-3xl h-15 max-sm:text-[16px] max-sm:rounded-2xl cursor-pointer'><img src={zap} alt=""/><p className='mt-4  pl-2 font-medium'>GET STARTED</p></button>
                </div>
            </div>
        </div>
    )
